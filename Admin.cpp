...
//
//void Admin::FareManagement(Subscription& sub) {
//
//    int stageNumber, newPrice, subType;
//
//
//    cout << "Enter the stage number :" << endl;
//    cin >> stageNumber;
//
//    cout << "Choose the customer type :" << endl;
//    cout << "==============================================" << endl;
//    cout << "1.Student" << endl;
...
//        break;
//    case 2:
//        type = SubscriptionType::PUBLIC_MONTH;
//        break;
//    case 3:
//        type = SubscriptionType::PUBLIC_YEAR;
//        break;
//    default:
...
//    cin >> newPrice;
//    sub.UpdateStagePrice(stageNumber, type, newPrice);
//
//}
//
...
//                break;
//            }
//            cout << "Enter the station that it's connected to" << endl;
//            cin >> connectedTo;
...
//            cin >> newName;
//            metro.editStation(Name, newName);
//            cout << "Metro station name updated successfully" << endl;
//            break;
//        }
//        case 3: {
//            string name;
...
//
//
//    /*for (auto it = SupportReply.begin(); it != SupportReply.end(); it++) {
//        cout << it->first << " : "<< endl;
//        cout << it->second << endl;
//    }*/
//
//    //for (auto & pair : SupportReply) {
//    //    SupportRespones.push(pair);
//    //}
//
//    SendReplies();
//
...
//    //    auto top = SupportRespones.front();
//    //    cout << "Question: " << top.first << "\nAnswer: " << top.second << endl;
//    //    SupportRespones.pop();
//    //}
